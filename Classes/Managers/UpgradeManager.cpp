...
// ===========================================================
			...
			public:
				...
				UpgradeButton(const char* pszFileName, Level* pWorld, UpgradeManager* pManager) :
					Entity(pszFileName)
					{
						...
						this->mWealth = new EntityManager(10, new Entity("pickup/pickup-stuffs-sprite.png", 1, 3), this);
				...
				void onTouch(CCTouch* touch, CCEvent* event)
				{
					...
					CocosDenshion::SimpleAudioEngine::sharedEngine()->playEffect("Sound/upgrade.wav");
				}
		...
		class DamageButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/fire-dmg.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;

					this->mLabel = CCLabelTTF::create("Fire Damage: 0 / 3", "Arial",  16);
		...
		class RateButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/fire-rate.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 5;

					this->mLabel = CCLabelTTF::create("Fire Rate: 0 / 5", "Arial",  16);
		...
		class SpeedButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/speed.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 5;
					
					this->mLabel = CCLabelTTF::create("Speed: 0 / 5", "Arial",  16);
		...
		class RegenerationButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/health-regen.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 5;
					
					this->mLabel = CCLabelTTF::create("Regeneration Rate: 0 / 5", "Arial",  16);
		...
		class HealthButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/max-health.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;
					
					this->mLabel = CCLabelTTF::create("Max Health: 0 / 3", "Arial",  16);
		...
		class BeamButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/juice-blast.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;
					
					this->mLabel = CCLabelTTF::create("Beem Ammo: 0 / 3", "Arial",  16);
		...
		class ShockwaveButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/base-wave-dmg.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;
					
					this->mLabel = CCLabelTTF::create("Shockwave Damage: 0 / 3", "Arial",  16);
		...
		class JetpackButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/engine-juice-power.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 2;
					
					this->mLabel = CCLabelTTF::create("Jetpack power: 0 / 2", "Arial",  16);
		...
		class FortificationButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/base-fortification.png", pWorld, pManager)
				{
					this->mCurrentIndex = 12;
					this->mMaxIndex = 23;
					
					this->mLabel = CCLabelTTF::create("Fortification: 12 / 23", "Arial",  16);
		...
		class BlasterButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/base-blast.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 5;
					
					this->mLabel = CCLabelTTF::create("Tower Blaster: 0 / 5", "Arial",  16);
		...
		class NovaButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/char-wave-dmg.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;
					
					this->mLabel = CCLabelTTF::create("Nova Defence: 0 / 3", "Arial",  16);
		...
		class SpidersButton : public UpgradeButton
		{
			public:
				...
				UpgradeButton("popup-menu-upgrade/def-pud.png", pWorld, pManager)
				{
					this->mCurrentIndex = 0;
					this->mMaxIndex = 3;
					
					this->mLabel = CCLabelTTF::create("Defence Spiders: 0 / 3", "Arial",  16);
...
UpgradeManager::UpgradeManager(Level* pWorld)
{
	...
	Entity* background = new Entity("popup-menu-upgrade/background.png");

	Entity* holder1 = new Entity("popup-menu-upgrade/holder1.png");
	Entity* holder2 = new Entity("popup-menu-upgrade/holder1.png");

	background->create()->setCenterPosition(Options::CAMERA_CENTER_X, Options::CAMERA_CENTER_Y);
	...
	for(int i = 0; i < 8; i++)
	{
		Entity* holder = new Entity("popup-menu-upgrade/holder2.png");
		UpgradeButton* icon;
